...
tags: ["Base Power", "AI funding", "AI infrastructure", "Series D", "AI data centers"]
related: ["ai-data-center-funding-2026", "biggest-ai-funding-rounds-2026", "valar-atomics-funding"]
faq: [{"q":"How much did Base Power raise?","a":"Base Power raised $1 billion in a Series D round announced on August 3, 2026, bringing its total raised to $2.5 billion across all rounds."},{"q":"What is Base Power's valuation?","a":"The Series D valued Base Power at $13 billion."},{"q":"Who invested in Base Power?","a":"The round was led by Ribbit Capital, Addition and Valor Equity Partners, with JPMorganChase also participating."},{"q":"What does Base Power do?","a":"Base Power builds distributed home battery storage systems that smooth grid demand, including demand created by AI data centers. It has regional deployments in Texas and Illinois."}]
---
...
1. **Venture capital is moving beyond model builders into grid infrastructure.** As AI data centers consume ever more electricity, distributed battery storage has emerged as a critical layer that keeps the broader grid stable — a shift also visible in [AI data center funding trends in 2026](/blog/ai-data-center-funding-2026).
2. **A $13 billion valuation for a home-battery company signals how seriously investors are pricing power constraints.** AI's growth is increasingly bottlenecked by electricity, not just chips or capital, and Base Power's raise is one of the clearest signs yet that solving the power problem is itself a venture-scale opportunity, alongside energy plays like [Valar Atomics](/blog/valar-atomics-funding).
3. **Bank participation points to a maturing asset class.** JPMorganChase joining alongside growth-stage VCs suggests grid-stabilization infrastructure is starting to look like a financeable, cash-flow-generating category rather than a pure moonshot.

Source: [TechCrunch — Base Power raises another $1B to save the grid using backyard batteries](https://techcrunch.com/2026/08/03/base-power-raises-another-1b-to-save-the-grid-using-backyard-batteries/)
