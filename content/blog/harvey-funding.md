...
tags: ["Harvey", "AI funding", "Series E", "legal AI"]
related: ["biggest-ai-funding-rounds-2026", "ai-agents-funding-2026", "cognition-funding"]
faq: [{"q":"How much did Harvey raise?","a":"Harvey raised more than $500 million in a Series E round announced in August 2026."},{"q":"What is Harvey's valuation?","a":"The Series E valued Harvey at $15.5 billion, up from its Series D valuation set just five months earlier in March 2026."},{"q":"Who invested in Harvey?","a":"The round was led by Lightspeed Venture Partners, with participation from GIC, Sequoia Capital, Andreessen Horowitz, Coatue, Kleiner Perkins, Google Ventures, Goldman Sachs Alternatives and JPMorgan Growth Equity Partners."},{"q":"What does Harvey do?","a":"Harvey is an AI platform for legal professionals that handles end-to-end document research, drafting, analysis and matter execution with source citations."}]
---
...
1. **Vertical AI is proving it can support massive valuations.** Harvey's ARR has reportedly surpassed $350 million with 80% year-over-year growth, putting its Series E valuation at roughly 44x revenue run-rate — a multiple that only holds up if investors believe legal automation is durable, not a pilot-stage fad.
2. **Category acceptance is now measurable.** Harvey says it's placed inside more than 60% of AmLaw 100 firms, which is a meaningfully different signal than early customer logos — it suggests legal AI has crossed from experimentation into standard practice at the largest firms.
3. **Legal AI sits inside the broader AI agents funding wave.** Harvey's jump from a $200M Series D to a $500M+ Series E in five months echoes the pace seen across [AI agents funding in 2026](/blog/ai-agents-funding-2026), where investors are rewarding companies that can show agents doing real, billable-grade work rather than just answering questions.
...
Source: [Harvey legal AI raises $500M+ at $15.5B valuation as ARR surges to $350M](https://thenextweb.com/news/harvey-legal-ai-15-5bn-valuation-500m-raise-vertical-ai)
