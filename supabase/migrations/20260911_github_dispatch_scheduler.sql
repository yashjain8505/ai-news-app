...
-- Schedules are UTC (IST = UTC + 5:30). Ordering rule: a curator run lands
-- ~35 min before whatever consumes it (a run takes 12-16 min), so waves and
-- the newsletter always draft from a fresh edition, never the previous one.
